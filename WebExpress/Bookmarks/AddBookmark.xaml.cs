...
namespace WebExpress
{
    ...
    public partial class AddBookmark : UserControl
    {
        ...
        private void button_Click(object sender, RoutedEventArgs e)
        {
            ...
            try
            {
                if (!System.IO.File.Exists(TabView.Bookmarkslayoutpath))
                {
                    string filePath = TabView.Bookmarkslayoutpath;
                ...
                string filePath1 = TabView.Bookmarkspath;
                ...
                string filePath2 = TabView.Bookspath;
